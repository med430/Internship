...
export function DangerZoneTab() {
  ...
  const onSubmit = async (data: DeleteFormInput) => {
    setIsDeleting(true);
    ...
    try {
      ...
      if (result.success) {
        toast.warning("Account Deactivated", {
          description:
            result.message || "You have 30 days to reactivate your account",
        });
        router.push("/login");
      } else {
        ...
        <div className="p-6 rounded-lg border-2 border-destructive/50 bg-destructive/5 space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Your account will be deactivated for 30 days. During this period,
              you can log back in to reactivate. After 30 days without
              reactivation, all your data will be permanently deleted.
            </p>
          </div>
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="space-y-3">
                  <p>
                    This action will deactivate your account for 30 days. You
                    can reactivate within this period by logging in.
                  </p>
                  <p className="font-semibold text-destructive">
                    After 30 days without reactivation, your account and all
