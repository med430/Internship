...
export function InterviewCard({ interview }: InterviewCardProps) {
  ...
  const strokeDashoffset =
    circumference - (interview.overall_score / 100) * circumference;
      ...
      >
        <div className="space-y-3">
          ...
          <div>
            ...
            <div className="space-y-1 text-xs">
              <div className="flex justify-between">
                ...
                <span className="text-foreground font-medium">
                  {Math.round(interview.technical_competency)}/100
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Communication:</span>
                <span className="text-foreground font-medium">
                  {Math.round(interview.communication_skills)}/100
                </span>
              </div>
              <div className="flex justify-between">
                <span className="text-muted-foreground">Problem Solving:</span>
                <span className="text-foreground font-medium">
                  {Math.round(interview.problem_solving)}/100
                </span>
              </div>
            </div>
          </div>
          <div>
            ...
            <span
              className={`text-sm font-semibold ${getScoreColor(interview.acceptance_probability)}`}
            >
