  ...
  return (
    <div className="group relative rounded-xl border border-border bg-card hover:shadow-lg transition-all duration-300 overflow-hidden">
      ...
      <div className="p-6 pt-20">
        ...
        <div className="mb-4">
          <Badge
            className={cn("border-0", matchLevel.textColor)}
            style={{
        ...
        <div className="space-y-2 mb-4">
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span>{toTitleCase(location)}</span>
            <span>•</span>
            <span>{formatTag(employmentType) || "Full-time"}</span>
          </div>
