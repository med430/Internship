    ...
    <div className="w-full max-w-full space-y-3 overflow-visible">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center gap-2 p-2 sm:gap-3 sm:p-3 rounded-xl bg-white/60 dark:bg-neutral-900/60 backdrop-blur-lg border border-neutral-200/50 dark:border-neutral-800/50">
        ...
        <Button
          ...
          className="sm:ml-auto sm:w-auto w-full text-xs sm:text-sm font-medium bg-neutral-900 hover:bg-neutral-800 dark:bg-neutral-100 dark:hover:bg-neutral-200 text-neutral-50 dark:text-neutral-900 shadow-sm transition-all duration-200 flex items-center justify-center h-7 sm:h-8"
        >
