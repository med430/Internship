...
exports.RegisterRecruiterHandler = void 0;
const cqrs_1 = require("@nestjs/cqrs");
const bcrypt = __importStar(require("bcrypt"));
const crypto_1 = require("crypto");
const register_recruiter_command_1 = require("../register-recruiter.command");
...
let RegisterRecruiterHandler = class RegisterRecruiterHandler extends generic_command_handler_1.GenericCommandHandler {
    userRepo;
    ...
    async map(command) {
        ...
        return new user_entity_1.User((0, crypto_1.randomUUID)(), command.email, command.name, command.lastname, command.username, hashedPassword, role_enum_1.Role.RECRUITER);
    }
    async persist(user) {
        ...
        await this.recruiterProfileRepo.save(new recruiter_profile_entity_1.RecruiterProfile((0, crypto_1.randomUUID)(), savedUser.id, this._command.company, this._command.companyDescription, this._command.website));
...
exports.RegisterRecruiterHandler = RegisterRecruiterHandler;
exports.RegisterRecruiterHandler = RegisterRecruiterHandler = __decorate([
    (0, cqrs_1.CommandHandler)(register_recruiter_command_1.RegisterRecruiterCommand),
...
//# sourceMappingURL=register-recruiter.handler.js.map